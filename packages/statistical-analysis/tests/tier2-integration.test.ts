...
const testExperiments: ExperimentData[] = [
  ...
  },
  {
    ...
    maac_processing_efficiency: 7.3,
    maac_construct_validity: 7.2,
  },
  // Communication Domain - Complex
  {
    ...
    maac_complexity_handling: 8.9,
    maac_hallucination_control: 9.3,
    maac_knowledge_transfer: 8.6,
    maac_processing_efficiency: 8.9,
    maac_construct_validity: 8.8,
  },
  {
    ...
    tier: 'simple',
    model_id: 'gpt_4o',
    maac_overall_score: 6.35,
    maac_cognitive_load: 6.2,
    maac_tool_execution: 6.5,
    maac_content_quality: 6.3,
    maac_memory_integration: 5.8,
    maac_complexity_handling: 6.1,
    maac_hallucination_control: 6.8,
    maac_knowledge_transfer: 6.0,
    maac_processing_efficiency: 6.2,
    maac_construct_validity: 6.1,
  },
  // Problem Solving Domain
  {
    ...
    maac_overall_score: 7.25,
    maac_cognitive_load: 7.1,
    maac_tool_execution: 7.4,
    maac_content_quality: 7.2,
    maac_memory_integration: 6.8,
    maac_complexity_handling: 7.0,
    maac_hallucination_control: 7.6,
    maac_knowledge_transfer: 7.0,
    maac_processing_efficiency: 7.1,
    maac_construct_validity: 7.0,
  },
  {
    ...
    tier: 'moderate',
    model_id: 'llama_maverick',
    maac_overall_score: 7.78,
    maac_cognitive_load: 7.6,
    maac_tool_execution: 7.9,
    maac_content_quality: 7.7,
    maac_memory_integration: 7.3,
    maac_complexity_handling: 7.5,
    maac_hallucination_control: 8.1,
    maac_knowledge_transfer: 7.5,
    maac_processing_efficiency: 7.6,
    maac_construct_validity: 7.5,
  },
  // Additional experiments for statistical significance
  {
    ...
    tier: 'complex',
    model_id: 'deepseek_v3',
    maac_overall_score: 8.65,
    maac_cognitive_load: 8.5,
    maac_tool_execution: 8.8,
    maac_content_quality: 8.5,
    maac_memory_integration: 8.2,
    maac_complexity_handling: 8.4,
    maac_hallucination_control: 9.1,
    maac_knowledge_transfer: 8.3,
    maac_processing_efficiency: 8.5,
    maac_construct_validity: 8.4,
  },
  {
    ...
    tier: 'simple',
    model_id: 'sonnet_37',
    maac_overall_score: 6.55,
    maac_cognitive_load: 6.4,
    maac_tool_execution: 6.7,
    maac_content_quality: 6.5,
    maac_memory_integration: 6.0,
    maac_complexity_handling: 6.3,
    maac_hallucination_control: 7.0,
    maac_knowledge_transfer: 6.2,
    maac_processing_efficiency: 6.4,
    maac_construct_validity: 6.3,
  },
  {
    ...
    tier: 'complex',
    model_id: 'gpt_4o',
    maac_overall_score: 8.15,
    maac_cognitive_load: 8.0,
    maac_tool_execution: 8.3,
    maac_content_quality: 8.1,
    maac_memory_integration: 7.7,
    maac_complexity_handling: 7.9,
    maac_hallucination_control: 8.5,
    maac_knowledge_transfer: 7.8,
    maac_processing_efficiency: 8.0,
    maac_construct_validity: 7.9,
  },
  {
    ...
    tier: 'moderate',
    model_id: 'llama_maverick',
    maac_overall_score: 7.95,
    maac_cognitive_load: 7.8,
    maac_tool_execution: 8.1,
    maac_content_quality: 7.9,
    maac_memory_integration: 7.5,
    maac_complexity_handling: 7.7,
    maac_hallucination_control: 8.3,
    maac_knowledge_transfer: 7.6,
    maac_processing_efficiency: 7.8,
    maac_construct_validity: 7.7,
  },
];
...
describe('Tier 2 Integration: Phase 1 - Data Preparation', () => {
  ...
  it('builds data matrix with correct dimensions', () => {
    ...
    // Verify first row values match first experiment
    expect(matrix[0][0]).toBe(7.8); // maac_cognitive_load
    expect(matrix[0][1]).toBe(8.2); // maac_tool_execution
    expect(matrix[0][2]).toBe(7.5); // maac_content_quality
  });
  ...
  it('extracts dimensional data correctly', () => {
    ...
    // Verify values
    expect(dimensional.maac_cognitive_load[0]).toBe(7.8);
    expect(dimensional.maac_hallucination_control[4]).toBe(9.3); // exp-005 has highest
  });
